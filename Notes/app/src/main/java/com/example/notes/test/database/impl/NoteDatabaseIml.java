...
import com.example.notes.test.database.impl.base.DatabaseImpl;
import com.example.notes.test.database.impl.model.NoteTableModel;
import com.example.notes.test.ui.data_model.NoteModel;

import java.util.ArrayList;
import java.util.List;

import static com.example.notes.test.database.impl.model.NoteTableModel.NotesEntry;
import static com.example.notes.test.database.impl.model.NoteTableModel.QUERY_DROP_TABLE;
