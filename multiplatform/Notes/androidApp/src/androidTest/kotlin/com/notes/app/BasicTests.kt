...
class BasicTests {
    ...
    class MockedService : AbstractStorageService() {
        ...
        override suspend fun delete(document: Document): Boolean = true

        override suspend fun fetchAll(): List<Document> = list
    ...
    @Test
    fun test01_encryptDecryptWithDerivedKey() =
        runTest {
    ...
    fun test06_override_files() =
        runTest {
            ...
            val notesOverrideList =
                listOf(
                    Notes(content = "note 1 Override", id = 1),
    ...
    @Test
    fun test07_if_derived_key_generates_stable_value() =
        runTest {
            val crypto = CryptoProvider()
