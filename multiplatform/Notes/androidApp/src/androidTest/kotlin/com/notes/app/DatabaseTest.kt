...
import com.notes.db.DBLifecycleCallback
import com.notes.db.LocalNoteDatabase
import com.notes.db.NoteDatabase
...
class DatabaseTest : AppTest() {
    ...
    fun test01_add_delete() =
        runTest {
            ...
            Log.i(
                "DatabaseTest",
                "test01_add_delete: encrypted content = " +
    ...
    @Test
    fun test04_initialize_races_case_1() =
        runTest {
            LocalNoteDatabase.close()
    ...
    @Test
    fun test05_initialize_races_case_2() =
        runTest {
            LocalNoteDatabase.close()
    ...
    @Test
    fun test06_metadata_note_db_update() =
        runTest {
            preConditionCheck()
