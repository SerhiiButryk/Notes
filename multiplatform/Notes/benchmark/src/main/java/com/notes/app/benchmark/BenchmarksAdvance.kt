...
class BenchmarksAdvance {
    ...
    @Test
    fun startupCompilationNone() = runTestBenchmark(CompilationMode.None())

    @Test
    fun startupCompilationBaselineProfiles() = runTestBenchmark(CompilationMode.Partial(BaselineProfileMode.Require))
